    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center">
            ...
            <p class="mt-6 text-blue-100 max-w-2xl mx-auto text-lg">
                Lihat hasil karya website yang telah kami buat. Setiap proyek dibuat dengan dedikasi tinggi dan desain modern.
            </p>
        </div>
    </div>
</section>
...
<section class="py-8 bg-white shadow-lg relative -mt-8 mx-4 lg:mx-auto max-w-4xl rounded-2xl z-10">
    <div class="grid grid-cols-3 divide-x divide-gray-100">
        ...
        <div class="text-center px-4">
            <div class="text-2xl md:text-3xl font-bold text-blue-700">24/7</div>
...
<section class="py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Koleksi <span class="gradient-text">Karya Kami</span></h2>
            <p class="mt-4 text-gray-600 max-w-xl mx-auto">Setiap website dibuat dengan standar kualitas tinggi dan desain yang memukau</p>
        </div> -->
...
<section class="py-20 bg-gradient-to-r from-blue-700 via-blue-800 to-indigo-900 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 text-center relative">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/6282314548114" target="_blank" class="inline-flex items-center bg-yellow-400 text-gray-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-yellow-500 transition shadow-xl hover:shadow-2xl">
            ...
            <a href="?page=contact" class="inline-flex items-center bg-white/10 backdrop-blur-sm border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-blue-700 transition">
                Hubungi Kami
