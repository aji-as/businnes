...
<head>
    ...
    <title>Hubungi Kami | GIESTAR</title>
            ...
            <div class="w-full lg:w-3/5 space-y-6 md:space-y-10">
                    ...
                    <form id="contactForm" class="space-y-4 md:space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="email" id="email" required class="w-full px-4 py-2.5 md:py-3 text-sm md:text-base rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition" placeholder="email@anda.com">
                            </div>
                        </div>
                        <div class="space-y-1.5">
                ...
                <div class="bg-blue-600 rounded-2xl md:rounded-3xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden">
                    <div class="relative z-10 text-center lg:text-left">
                        ...
                        <a href="https://wa.me/6282314548114" target="_blank" class="inline-flex items-center justify-center bg-green-500 text-white px-6 py-3 md:px-8 md:py-3.5 rounded-full font-bold text-sm md:text-base hover:bg-green-600 transition shadow-lg w-full sm:w-auto">
                ...
                <div class="bg-gray-50 rounded-2xl md:rounded-3xl p-6 md:p-8 border border-gray-100 shadow-sm space-y-6 md:space-y-8">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-900 text-base md:text-lg">+62 823-1454-8114</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-gray-900 text-base md:text-lg">giestar@gmail.com</p>
                        </div>
                    </div>
...
<script>
    // 1. SCRIPT UNTUK NAVBAR MOBILE
    const btn = document.getElementById('mobile-menu-btn');
    const menu = document.getElementById('mobile-menu');

    // Cek apakah tombol ada di halaman
    if (btn && menu) {
